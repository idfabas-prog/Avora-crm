...
test("message jobs fetch by conversation, link messages, and advance parent last_message_at safely", async () => {
  ...
  globalThis.fetch = async (url, init) => {
    ...
    return new Response(JSON.stringify({
      messages: [
        { id: "ghl-msg-new", conversationId: "ghl-conv-1", contactId: "ghl-contact-1", direction: "inbound", channel: "sms", body: "Newer message", timestamp: "2026-08-20T12:00:00.000Z" },
        { id: "ghl-msg-old", conversationId: "ghl-conv-1", contactId: "ghl-contact-1", direction: "outbound", channel: "sms", body: "Older message", timestamp: "2026-08-13T12:00:00.000Z" }
      ],
      total: 2
