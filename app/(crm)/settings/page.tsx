  ...
  return (
    <div className="page-stack">
      ...
      <section className="settings-nav">
        ...
        <Link href="/settings/executive">Executive</Link>
        <Link href="/settings/executive/targets">Executive Targets</Link>
        <Link href="/settings/inventory">Inventory</Link>
        <Link href="/settings/workforce">Workforce</Link>
        <Link href="/settings/mobile">Mobile / PWA</Link>
        ...
        <Link href="/settings/integrations/gohighlevel">GoHighLevel</Link>
        <Link href="/settings/integrations/gohighlevel/calendars">GHL Calendars</Link>
        <Link href="/settings/marketing/sources">Marketing Sources</Link>
        <Link href="/settings/marketing/campaigns">Marketing Campaigns</Link>
        <Link href="/settings/campaigns">Lifecycle Campaign Settings</Link>
        <Link href="/settings/reputation">Reputation</Link>
        <Link href="/settings/reputation/sources">Review Sources</Link>
        <Link href="/settings/referrals">Referral Programs</Link>
        <Link href="/settings/portal">Patient Portal</Link>
        <Link href="/settings/memberships">Memberships</Link>
