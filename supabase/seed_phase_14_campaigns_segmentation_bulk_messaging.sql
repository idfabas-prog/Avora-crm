...
campaign_rows as (
  ...
  join (
    values
      ...
      ('Draft Workflow Enrollment Demo', 'Draft campaign that enrolls eligible contacts into an existing workflow without duplicating the workflow engine.', 'workflow_enrollment', 'draft', 'Jacksonville No-Show Follow-Up', 'workflow', 'campaign', null::timestamptz, null::text, '{"mode":"locations","location_slugs":["jacksonville"]}', '{"demo":true,"simulation":true}')
